                        ...
                        <div className="special-review">
                            ...
                            <div className="assets-container">
                                <div className="assets">
                                    ...
                                    <CountUp end={232} duration={3}/>
                                    </p>
                                    <hr />
                                    <h4>project Completed</h4>
                                </div>
                                <div className="assets">
                                    <p><i className="fas fa-user"></i> <CountUp end={340} duration={3} suffix='+' /></p>
                                    <hr />
                                    <h4>Work Employed</h4>
                                </div>
                                <div className="assets">
                                    <p><i className="fas fa-trophy"></i> <CountUp end={50} duration={3} suffix='+' /></p>
                                    <hr />
